...
<!--# Wat betreft de UU storage finder: deze bevat toch informatie die niet helemaal klopt (bijv. over USB-sticks/"mobile storage (encrypted)", dat die security 'high' hebben). Zou het niet beter zijn om al naar de nieuwe storage finder te verwijzen? -->
