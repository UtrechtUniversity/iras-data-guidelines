...
This chapter will guide you through the steps to take when making a plan to organize your data. It discusses all the tools that are available in the Utrecht University and points you to relevant resources you can use. The advice is to consult the data management representative of your research group to discuss the best option for your research project.
...
## Organize your data using a intuitive folder structure
...
Some recommendations for naming research folders:

-   Preferably as short as possible o Includes project name
