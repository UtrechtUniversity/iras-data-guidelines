...
If you want to learn more about data in the final phases of your research, please consult @sec-after_archiving and @sec-after_publishing.
...
<!--# Huidige UU storage finder bevat informatie die niet helemaal klopt (bijv. over "mobile storage (encrypted)" - dat die security 'high' heeft). T.z.t. naar nieuwe storage finder verwijzen, maar is nu nog te vroeg om deze te delen aldus Rene. -->
...
<!--# Het zou denk ik goed zijn om ergens definities te geven. Bijv. met betrekking tot personal data, identifying personal data, pseudonymized data, anonymous data, etc. Dit opnemen in het hoofdstuk over privacy. -->

<!--# Daarnaast worden termen nog wel eens door elkaar gebruikt: personal data als eigenlijk identifying personal data wordt bedoeld etc. Hier moet een keertje kritisch naar gekeken worden. -->
